...
<html lang="fr" class="h-100">
    <head>
        ...
        <title><?= isset($title) ? e($title) : 'The Shadow Spies' ?></title>
    ...
    <body class="d-flex flex-column h-100">
        ...
        <div class="container-fluid">
            ...
            <div class="row flex-nowrap">
                ...
                <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                       <div
                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                            id="menu">
                            <li class="nav-item">
                                <a href="/the_shadow_spies/" class="nav-link align-middle px-0">
